...
Reset_Handler:
  ldr   sp, =_RAMEND    /* Atollic update: set stack pointer */
...
ram_paint_copy_byte:
			CMP R1, R2			//porovnani aktualni adr a adr konce ram
			BCS ram_paint_end
			STR R0,[R1]
			ADD R1, R1, #4		//increment actual ram address

			B	ram_paint_copy_byte
ram_paint_end:
